  ...
  () => {
    ...
    const handleSaveEdit =
      async (
        ...
        // --- NEW: STRICT MINIMUM PRICE ENGINE (VAULT FIX) ---
        ...
        if (
          ...
          setError(
            `The minimum allowed price for ${activeCurrency} is ${minRequiredPrice}. Please increase your price or set it to 0 to make it free.`,
          );
          setIsSaving(
            false,
          );
